    ...
    extend: {
      keyframes: {
        ...
        fireFlyMove: {
          ...
          "50%": { transform: "translate(200px,-200px) rotate(-135deg)" },
          "75%": { transform: "translate(-500px,500px) rotate(-135deg)" },
          "80%": { transform: "translate(100px,500px) rotate(0deg)" },
      ...
      animation: {
        ...
        fireFlyMove: "fireFlyMove 15s linear infinite",
      },
    },
  },
  plugins: [],
